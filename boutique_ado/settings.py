...
# Old Secret Key SECRET_KEY = 'django-insecure-2k1qw75+vx==$cd9@gse#&idp*d@yw!vv00d4h$(7r3b97-3(3'
...
INSTALLED_APPS = [
    ...
    'checkout',  # checkout app created
    'profiles',  # profile app created
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'ferdia-boutique-ado'
